...
function updateCartTotal() {
  ...
  for (var i = 0; i < cartRows.length; i++) {
      ...
      var qtde = parseFloat(qtdeElement.innerText.replace('meia', 0.5))
...
remove32.addEventListener('click', function(){
  ...
  let integer48 = 0
    ...
    function send_handle(){
      ...
      var win = window.open(`https://wa.me/5588994053525?text=
      *CHEGOU%20MAIS%20UM%20PEDIDO*%0A
      ...
      O%20Valor%20total%20do%20meu%20pedido%20é:%20*${valor}*%0A
      A%20forma%20de%20pagamento%20é%20*${pagamento}*%0A
      Observação:%20*${obs}*`, '_blank');
     // win.focus();
    }
